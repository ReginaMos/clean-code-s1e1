...
var createNewTaskElement=function(taskString){
    ...
    label.className='tasks__item tasks__item-label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="tasks__item-checkbox";
    editInput.type="text";
    editInput.className="tasks__item tasks__item-input";
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.tasks__btn-edit");
    var deleteButton=taskListItem.querySelector("button.tasks__btn-delete");
